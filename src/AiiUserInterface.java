...
public class AiiUserInterface {
	     ...
	     */
	    public AiiUserInterface(TimingEngine engine)
	    {
	        timer = engine;
	        makeFrame();
	        updateDisplay();
	    ...
	    private void updateDisplay()
	    {
	        ...
	        lastTimeLabel.setText(timeToString(timer.getLastTime()));
	        avgTimeLabel.setText(timeToString(timer.getAverageTime()));
	        totalTimeLabel.setText(timeToString(timer.getTotalTime()));
	    ...
	    {
	        frame = new JFrame("Aii Lap Timer 2012");
